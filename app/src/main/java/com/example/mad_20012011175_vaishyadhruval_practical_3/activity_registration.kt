package com.example.mad_20012011175_vaishyadhruval_practical_3

import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.example.mad_20012011175_vaishyadhruval_practical_3.databinding.ActivityRegistrationBinding
...
class activity_registration : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvLogin.setOnClickListener{
            Intent(this,activity_login::class.java).apply {startActivity(this)}
        }
